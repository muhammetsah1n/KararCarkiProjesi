<html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="sekizliCarkSayfasi.css?v=<?php echo time(); ?>">
        <script src="sekizliCarkSayfasi.js?v=<?php echo time(); ?>" defer></script>
        ...
        <div class="kutu">
            ...
            <div class="container">
                ...
                <div class="wheel">
                    ...
                    <div class="secenek6"><div class="text" id="secenek6"></div></div>
                    <div class="secenek7"><div class="text" id="secenek7"></div></div>
                    <div class="secenek8"><div class="text" id="secenek8"></div></div>
